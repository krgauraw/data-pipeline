...
class QuestionPublishUtilSpec extends FlatSpec with BeforeAndAfterAll with Matchers with MockitoSugar {
  ...
  "publishQuestions " should " publish questions in questionset " in {
    ...
    val publishedQuestions = QuestionPublishUtil.publishQuestions(identifier, objList, 1, "sunbird")(ec, mockNeo4JUtil, cassandraUtil, readerConfig, cloudStorageUtil, defCache, defConfig, jobConfig, httpUtil)
